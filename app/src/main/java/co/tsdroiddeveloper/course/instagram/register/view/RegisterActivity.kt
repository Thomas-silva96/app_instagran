...
import co.tsdroiddeveloper.course.instagram.common.extension.hideKeyboard
...
class RegisterActivity : AppCompatActivity(), FragmentAttachListener {
    ...
    override fun goToGalleryScreen() = getContent.launch("image/*")
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            photoFile?.also {
                val photoUri = FileProvider.getUriForFile(
                    this,
                    "co.tsdroiddeveloper.course.instagram.fileprovider",
                    it
                )
